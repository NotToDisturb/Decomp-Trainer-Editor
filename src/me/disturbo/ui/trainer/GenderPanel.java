...
public class GenderPanel extends JPanel {
    /*
            The GenderPanel class contains the buttons needed for gender selection:
             - Male: when selecting it, it deselects Female
             - Female: when selecting it, it deselects Male
    */
